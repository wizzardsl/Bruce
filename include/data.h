...
*/
R_API data_t *
data_dbl(data_t *first, char const *key, char const *pretty_key, char const *format, double val);
...
*/
R_API data_t *
data_str(data_t *first, char const *key, char const *pretty_key, char const *format, char const *val);
...
*/
R_API data_t *
data_ary(data_t *first, char const *key, char const *pretty_key, char const *format, data_array_t *val);
...
*/
R_API data_t *
data_dat(data_t *first, char const *key, char const *pretty_key, char const *format, data_t *val);
...
R_API data_t *data_hex(
    data_t *first, char const *key, char const *pretty_key, char const *format, uint8_t const *val,
